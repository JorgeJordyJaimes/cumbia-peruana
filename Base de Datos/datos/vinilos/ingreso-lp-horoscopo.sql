...
(1, 4, 'El Millón de Los Destellos', 'ELD-0201170', 1974, 2, TRUE),
(1, 4, 'Carmen Rosa y otros Éxitos', 'ELD-0201411', 1976, 2, TRUE),
(1, 4, 'Una Hora con Los Destellos', 'ELD-05011276', 1985, 2, TRUE);
...
(7, 2, 'Éxitos, Éxitos, Éxitos', 'HLP-1002', 1981, 2, TRUE);
...
(9, 2, 'Feliz Aniversario', 'HLP-1020', 1984, 2, TRUE),
(9, 2, 'En Vivo', 'HLP-1028', 1984, 2, TRUE),
(9, 2, 'A Bailar la Onda Tropical Andina', 'HLP-1042', 1985, 2, TRUE);
...
(17, 1, 'Disco de Oro', 'INF-208412', 1985, 2, TRUE);
...
INSERT INTO Albumes (id_sello, nombre_album, numero_catalogo, año_publicacion, id_tipo_album, es_varios_artistas)
VALUES

(2, 'Festival Tropical', 'HLP-1019', 1983, 2, TRUE),
(2, 'Festival de Cumbias Vol. 2', 'HLP-1027', 1984, 2, TRUE),
(2, 'Como Pan Caliente', 'HLP-1041', 1985, 2, TRUE);
